...
Media Backup Server `0.3.16` 是自托管的照片与视频备份服务。Rust/Axum 服务端负责移动设备配对、分块上传、媒体索引和文件交付，内置管理 Web 用于管理备份实例、账号和运行状态。
...
./scripts/test-deployment.sh \
  "$PWD/dist/media-backup-server-0.3.16-x86_64-unknown-linux-gnu.tar.gz"
```
