...
readonly package="media-backup-server-0.3.2-x86_64-unknown-linux-gnu"
readonly version="0.3.2"
readonly contract="5af7635e08f346d66cb01fbf99bb464dfbd81a8e9c4ea0ed897f2b6c651d45d3"
...
[[ -n "$archive_arg" ]] ||
  fail "usage: test-deployment.sh /absolute/path/media-backup-server-0.3.2-x86_64-unknown-linux-gnu.tar.gz"
...
assert identity["release_contract_sha256"] == "5af7635e08f346d66cb01fbf99bb464dfbd81a8e9c4ea0ed897f2b6c651d45d3"
PY
...
for setting in \
  ...
  'ExecStart=/opt/isarmg/media-backup/releases/0.3.2/bin/media-backup-server serve-release /opt/isarmg/media-backup/releases/0.3.2' \
