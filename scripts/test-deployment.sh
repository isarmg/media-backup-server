...
readonly package="media-backup-server-0.3.4-x86_64-unknown-linux-gnu"
readonly version="0.3.4"
readonly contract="9ec4b443cff26e83721af588f09cc7860615f909076efcae51eaffbc95a6fce4"
...
[[ -n "$archive_arg" ]] ||
  fail "usage: test-deployment.sh /absolute/path/media-backup-server-0.3.4-x86_64-unknown-linux-gnu.tar.gz"
...
assert identity["release_contract_sha256"] == "9ec4b443cff26e83721af588f09cc7860615f909076efcae51eaffbc95a6fce4"
PY
...
for setting in \
  ...
  'ExecStart=/opt/isarmg/media-backup/releases/0.3.4/bin/media-backup-server serve-release /opt/isarmg/media-backup/releases/0.3.4' \
