...
readonly release_contract_sha256="375da139b67519a8a404eb682429c311e874f5ed6eb15c16cb01de8ea7a20701"
...
expected_identity = {
    ...
    "release_contract_sha256": "375da139b67519a8a404eb682429c311e874f5ed6eb15c16cb01de8ea7a20701",
}
...
if [[ -e "$preflight_release_path" || -L "$preflight_release_path" ]]; then
  die "release 0.3.9 destination already exists; installation is one-shot and no-clobber"
fi
...
[[ ! -e "$release_path" && ! -L "$release_path" ]] ||
  die "release 0.3.9 destination appeared during installation"
