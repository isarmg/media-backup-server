...
readonly release_contract_sha256="83bf1af2d048003500d37286b97f193fe20ef8ab1a9cd3a9f69b359de2daf0aa"
...
expected_identity = {
    ...
    "web_assets_sha256": "2c5fcfcf8fab393b80ff503ca2fcaacfefbc8b97837cf714d0757a1679882466",
    "release_contract_sha256": "83bf1af2d048003500d37286b97f193fe20ef8ab1a9cd3a9f69b359de2daf0aa",
}
...
if [[ -e "$preflight_release_path" || -L "$preflight_release_path" ]]; then
  die "release 0.3.21 destination already exists; installation is one-shot and no-clobber"
fi
...
[[ ! -e "$release_path" && ! -L "$release_path" ]] ||
  die "release 0.3.21 destination appeared during installation"
