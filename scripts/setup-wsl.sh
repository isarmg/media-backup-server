...
readonly release_contract_sha256="d53e499df66d5213a47b628816227d0ccc7b64b12d1db116c582b4ec14389512"
...
expected_identity = {
    ...
    "web_assets_sha256": "794aceba833afa04fdc5ec435549dd395575e94230c11a845380a30dc5351d2d",
    "release_contract_sha256": "d53e499df66d5213a47b628816227d0ccc7b64b12d1db116c582b4ec14389512",
}
...
if [[ -e "$preflight_release_path" || -L "$preflight_release_path" ]]; then
  die "release 0.3.10 destination already exists; installation is one-shot and no-clobber"
fi
...
[[ ! -e "$release_path" && ! -L "$release_path" ]] ||
  die "release 0.3.10 destination appeared during installation"
